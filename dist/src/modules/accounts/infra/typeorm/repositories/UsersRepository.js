...
var UsersRepository = /** @class */ (function () {
    ...
    UsersRepository.prototype.create = function (_a) {
        var name = _a.name, email = _a.email, password = _a.password, driver_license = _a.driver_license, avatar = _a.avatar, id = _a.id;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.repository.save(newUser)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
