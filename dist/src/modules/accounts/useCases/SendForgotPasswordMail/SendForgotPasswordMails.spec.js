...
describe("Send forgot mail", function () {
    ...
    it("Should be able to send forgot password mail to user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("aedbew@ospa.com")];
                case 2:
                    _a.sent();
    ...
    it("Should not be able to send an email if user does not exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordMailUseCase.execute("ka@uj.gr")).rejects.toEqual(new AppError_1.AppError('User does not exists'))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("abone@ospa.com")];
                case 1:
                    _a.sent();
