...
var AuthenticateUserUseCase = /** @class */ (function () {
    ...
    AuthenticateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, expires_in, secret_refresh_token, secret_token, expires_in_refresh_token, expires_refresh_token_days, passwordMatch, token, refresh_token, refresh_token_expires_date, tokenReturn;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findByEmail(email)];
                    case 1:
                        user = _b.sent();
                        expires_in = auth_1.default.expires_in, secret_refresh_token = auth_1.default.secret_refresh_token, secret_token = auth_1.default.secret_token, expires_in_refresh_token = auth_1.default.expires_in_refresh_token, expires_refresh_token_days = auth_1.default.expires_refresh_token_days;
                        if (!user) {
