...
var SpecificationInMemory_1 = require("@modules/cars/repositories/In-memory/SpecificationInMemory");
...
describe("Create car specification", function () {
    beforeEach(function () {
        ...
        specificationsRepositoryInMemory = new SpecificationInMemory_1.SpecificationInMemory();
    ...
    it("Shoul not be able to add a new specification to a non existant car", function () { return __awaiter(void 0, void 0, void 0, function () {
        var car_id, specifications_id;
        return __generator(this, function (_a) {
            car_id = "1234";
            specifications_id = ["5432"];
            expect(createCarSpecificationUseCase.execute({ car_id: car_id, specifications_id: specifications_id })).rejects.toEqual(new AppError_1.AppError("Car does not exists"));
            return [2 /*return*/];
        });
    }); });
